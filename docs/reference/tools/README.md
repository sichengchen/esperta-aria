...
Esperta Aria provides 22 built-in tools organized by danger level, plus dynamic `mcp_*`
...
| 22  | projects_control | moderate    | Queue and run project dispatches      |
...
For `exec`: the hybrid classifier runs _after_ override resolution. If you
