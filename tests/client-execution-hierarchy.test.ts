...
import { createProjectEnvironmentListItem, createProjectServerRoster } from "@aria/work/client";
...
describe("client execution hierarchy seams", () => {
  ...
  test("@aria/work formats project environment options for shell selectors", () => {
    expect(
  ...
  test("@aria/access-client and @aria/work keep active server selection stable for clients", () => {
