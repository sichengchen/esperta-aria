...
| `tests/server/automation-e2e.test.ts`           | `AUT-003` `AUT-004` `AUT-005` `AUT-006` `AFLOW-002` `AFLOW-003` `AFLOW-005`                                                                                        |
| `tests/server/connector-flow.test.ts`           | `AUT-009` `CON-002` `CON-003` `CON-004` `CON-005` `CON-007` `CON-008` `CFLOW-001` `CFLOW-002` `CFLOW-003` `CFLOW-004` `CFLOW-005`                                  |
