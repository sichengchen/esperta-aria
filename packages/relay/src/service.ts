...
export class RelayService {
  ...
  async attachSession(
    ...
    const attachment: RelaySessionAttachmentRecord = existing ? {
      ...existing,
      serverId: request.serverId ?? existing.serverId ?? null,
      workspaceId: request.workspaceId ?? existing.workspaceId ?? null,
      ...
      attachmentKind: request.attachmentKind ?? existing.attachmentKind ?? null,
      transportMode: request.transportMode ?? existing.transportMode ?? null,
