...
## Progress
- Implemented TelegramTransport with Grammy, streaming edit-message pattern with throttling
- Formatter: escapeMarkdown, formatToolResult, splitMessage (handles 4096 char limit)
- Security: allowedChatId restriction, --telegram-only flag support
- Modified: src/telegram/transport.ts, src/telegram/formatter.ts, src/telegram/index.ts, src/index.ts, tests/telegram.test.ts
- Verification: passed — 63 tests pass, typecheck clean
